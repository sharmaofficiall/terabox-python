...
async def start_token(m: Message):
    ...
    if not check_if:
        return await m.reply(
            "You haven't joined @sharmamod01 or @sharmamod01 yet. Please join the channel and then send me the link again.\nThank you!",
            buttons=[
                [
                    Button.url("sharmamod01", url="https://t.me/sharmamod01"),
                    Button.url("sharmamod01",
                               url="https://t.me/sharmamod01"),
                ],
                [
                    Button.url(
                        "ReCheck ♻️",
